...
* Load libraries, Retrieve dataset and unzip.
...
* Assumed these were only variables with mean(): Mean value std(): Standard deviation which is why in step 1 I replaced Mean()- with Mean_ and Std()- with Std_
